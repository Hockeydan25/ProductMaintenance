...
namespace ProductMaintenance.Models.DataLayer
{
    ...
    {
        /// <summary>
        /// creating a sqlcommand to run on DB execute select statement, parameters.
        /// GetProduct for productCode returns product object 
        /// code that opens and closes connection read files
        /// </summary>
        ...
        /// <summary>
        /// add a new row to the Products table, receives a product object with the data for the new row
        /// SQL insert statement to insert new data into the row, and execution command.
        /// </summary>
        ...
        /// <summary>
        /// two objects and old and new are dealt with here.methods to update DB and execute
        /// values return to see if update was sucessful. only update is value was retrieved 
        /// </summary>
        ...
        public static bool UpdateProduct(Product oldProduct, Product newProduct)
        {
            ...
            connection.Open();
            int count = command.ExecuteNonQuery(); //method 

            return (count > 0);
        }

        /// <summary>
        /// method receives a product object as an argument. using similar method to check changes
        /// agian where clause to determine value of what will be deleted
        /// </summary>
        /// <param name="product"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Method if you try to delete the product orgiionally retrieved but has changed a
        /// concurrancy error is thrown. check all properties not just one here.
        /// </summary>
        /// <param name="productCode"></param>
